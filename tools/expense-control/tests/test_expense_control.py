...
def test_numbers():
    ...
    check("TEB whole lira is positive", ec.parse_amount("TL.345,-"), 345.0)
    check("TEB thousands", ec.parse_amount("TL.2.523,90"), 2523.90)
    check("TEB leading minus", ec.parse_amount("-TL.92.498,33"), -92498.33)
    check("Garanti trailing minus still negative", ec.parse_amount("1.064,75-"), -1064.75)
